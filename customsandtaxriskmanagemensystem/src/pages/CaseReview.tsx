...
export default function CaseReview() {
  ...
  // Scrolls the chat *container* (the flex-1 overflow-y-auto div) to its
  // bottom. We avoid `chatEndRef.current?.scrollIntoView()` because when
  // the chat panel itself is below the viewport, the browser cascades
  // the scroll up to the page — yanking the whole case-review out of
  // place every time a message arrives. Setting scrollTop on the
  // immediate parent container is internal to the panel and never
  // touches the page scroll.
